            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <ul class="topbar-list">
                        <li>
                            <a href="https://www.facebook.com/afrahtravelandtourservices/"><i
                                    class="fab fa-facebook"></i></a>
                            <a href="https://www.instagram.com/afrah_travels/"><i class="fab fa-instagram"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="https://www.linkedin.com/in/afrah-travel-and-tour-services-14623a264/"><i
                                    class="fab fa-linkedin"></i></a>
                        </li>
                        <li><a href="#!"><span>+92 310 0009710</span></a></li>
                        <li><a href="#!"><span>+92 310-2299115</span></a></li>
                        <li><a href="#!"><span>info@afrahtravel.com.pk</span></a></li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-6">
