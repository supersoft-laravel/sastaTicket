...
Route::name('frontend.')->group(function () {
    ...
    Route::get('/flights', [FrontendHomeController::class, 'flights'])->name('flights');
...
Route::get('/airports', function () {
    return Cache::remember('airports', 86400, function () {
        return Http::get('https://api.dedolist.com/api/v1/locations/airports/')->json();
    });
});
